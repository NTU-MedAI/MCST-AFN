...
def parse_args():
    ...
    parser.add_argument('--generate', type=bool, default=True,help='Whether to use the Conformational generation task.')
    parser.add_argument('--Normalization', type=bool, default=False,help='Whether to use the Conformational generation task.')
    ...
    parser.add_argument('--max_sample', type=int, default=50,help='The default number of pre-train samples.')

    # set fine-tune hyper-parameters
    parser.add_argument('--data', type=str, default='bbbp')#, choices=['lba', 'lep'])
    parser.add_argument('--unknown', type=bool, default=True, help='Whether to use docking structures.')
    parser.add_argument('--pretrain', type=str, default='model_MTL_7_e6.pt', help='Whether to load the pretrained model weights.')
    ...
    parser.add_argument('--max_len', type=int, default=100, help='Maximum number of nodes for the input graph.')
    ...
    parser.add_argument('--min_lr', type=float, default=5e-8, help='The minimum learning rate.')
    ...
    parser.add_argument('--gpu', type=str, default='1', help='Index for GPU')
