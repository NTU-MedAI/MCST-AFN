...
def main(number):
    ...
    x_full_dataset, pos_full_dataset, y_full_dataset = torch.load(f'data_freesolv/freesolv/full.pt')
    ...
    for epoch in range(0, args.epochs):
        ...
        if  args.data == 'freesolv' and metric < best_metric:
            ...
            early_stop += 1
        if early_stop >= 100: log.logger.info('Early Stopping!!! No Improvement on Loss for 50 Epochs.'); break
