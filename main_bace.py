...
def main():
    ...
    x_train, pos_train, y_train = torch.load(f'data_bace/bace/train.pt')
    x_val, pos_val, y_val = torch.load(f'data_bace/bace/test.pt')
    x_test, pos_test, y_test = torch.load(f'data_bace/bace/val.pt')
