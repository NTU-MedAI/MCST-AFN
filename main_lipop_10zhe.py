...
def main(number):
    ...
    x_full_dataset, pos_full_dataset, y_full_dataset = torch.load(f'data_lipop/lipop/full.pt')
    ...
    for epoch in range(0, args.epochs):
        ...
        log.logger.info(
            ...
            '| Lr: {:.3f}'.format(epoch + 1, time() - t1, loss * 1e4, metric, pearson, spearman, metric_test,
                                  pearson_test, spearman_test,
